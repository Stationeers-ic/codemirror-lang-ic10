export const allInstructions: { name: string; preview: string; description: string; snippet: string; deprecated?: boolean }[] =
	[
		{
			name: "l",
			snippet: "${r0} ${d0} ${}",
		...
		{ name: "j", snippet: "${}", preview: "j int", description: "Jump execution to line a" },
		{
			name: "bdse",
			snippet: "${d0} ${}",
		...
		{ name: "jr", snippet: "${}", preview: "jr int", description: "Relative jump to line a" },
		{
			name: "brdse",
			snippet: "${d0} ${}",
		...
		{ name: "log", snippet: "${r0} ${}", preview: "log r? a(r?|num)", description: "Register = log(a)" },
		{ name: "exp", snippet: "${r0} ${}", preview: "exp r? a(r?|num)", description: "Register = exp(a)" },
		{
			name: "rand",
			snippet: "${r0}",
			preview: "rand r?",
		...
		{ name: "yield", snippet: "", preview: "yield", description: "Pauses execution for 1 tick" },
		{ name: "label", snippet: "", preview: "", description: "DEPRECATED", deprecated: true },
		{
			name: "peek",
			snippet: "${r0}",
			preview: "peek r?",
		...
		{ name: "hcf", snippet: "", preview: "hcf", description: "Halt and catch fire" },
		{
			name: "select",
			snippet: "${r0} ${} ${} ${}",
